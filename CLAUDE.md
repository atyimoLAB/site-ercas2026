...
Static website for **ERCAS 2026** (Escola Regional de Computação Aplicada à Saúde), a health-informatics conference in Salvador/BA, Oct 13–15 2026. Built with **Jekyll 4.4** + the **`jekyll-theme-conference`** (~4.0.2) theme, deployed to GitHub Pages. The site is currently **single-language PT-BR**.
